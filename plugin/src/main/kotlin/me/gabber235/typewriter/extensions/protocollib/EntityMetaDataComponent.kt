...
import me.gabber235.typewriter.extensions.protocollib.EntityFields.STATUS


private interface EntityMetaDataField {
	fun create(): WrappedDataValue
}

private enum class EntityFields(val defaultGenerator: () -> EntityMetaDataField) {
