...
sealed class UserOrganizationsSnapshot_orMutable {
  ...
  _core.Iterable<Organization_orMutable> get values;
...
final class UserOrganizationsSnapshot implements UserOrganizationsSnapshot_orMutable {
  ...
  @_core.override
  final _core.Iterable<Organization> values;
  _skir.internal__UnrecognizedFields? _u;

  factory UserOrganizationsSnapshot({
    required _core.int sequence,
    required _core.Iterable<Organization_orMutable> values,
  ...
  static final _serializerBuilder = _skir.internal__StructSerializerBuilder(
    ...
    defaultInstance: defaultInstance,
    newMutable: (it) => (it != null) ? it.toMutable() : mutable(),
    toFrozen: (UserOrganizationsSnapshot_mutable it) => it.toFrozen(),
    getUnrecognizedFields: (it) => it._u,
    setUnrecognizedFields: (it, u) => it._u = u,
  );
}
...
final class UserOrganizationsSnapshot_mutable implements UserOrganizationsSnapshot_orMutable {
  ...
  _core.List<Organization_orMutable> get mutableValues {
    ...
    if (value is _skir.internal__MutableList<Organization_orMutable>) {
      return value;
    } else {
...
///   ```
///   switch (e) {
///     case UserOrganizationsChange_unknown(): { ... }
///     case UserOrganizationsChange_add(:var value): { ... }
///     case UserOrganizationsChange_remove(:var value): { ... }
///   }
///   ```
///
/// Deeply immutable.
sealed class UserOrganizationsChange {
  ...
  factory UserOrganizationsChange.createRemove({
  ...
  static _skir.EnumSerializer<UserOrganizationsChange> get serializer {
    if (_serializerBuilder.mustInitialize()) {
      _serializerBuilder.addWrapperVariant(
        ...
        Organization.serializer,
        "",
        UserOrganizationsChange_addWrapper._,
        (it) => it.value,
        ordinal: UserOrganizationsChange_kind.addWrapper._ordinal,
      );
      _serializerBuilder.addWrapperVariant(
        2,
        "remove",
        ...
        _lib_kernel_v1_record_id.RecordId.serializer,
        "",
        UserOrganizationsChange_removeWrapper._,
        (it) => it.value,
        ordinal: UserOrganizationsChange_kind.removeWrapper._ordinal,
      );
      _serializerBuilder.finalize();
    }
    return _serializerBuilder.serializer;
...
enum UserOrganizationsChange_kind {
  unknown(0),
  addWrapper(1),
  removeWrapper(2);
  ...
  const UserOrganizationsChange_kind(this._ordinal);
}

final class UserOrganizationsChange_unknown implements UserOrganizationsChange {
  static const _instance = UserOrganizationsChange_unknown._();

  final _skir.internal__UnrecognizedVariant? _u;

  const UserOrganizationsChange_unknown._() : _u = null;
  UserOrganizationsChange_unknown._unrecognized(this._u);

  @_core.override
  UserOrganizationsChange_kind get kind => UserOrganizationsChange_kind.unknown;
  @_core.override
  _core.bool operator ==(other) => other is UserOrganizationsChange_unknown;
  @_core.override
...
sealed class _UserOrganizationsChange_wrapper implements UserOrganizationsChange {
  ...
  @_core.override
  _core.bool operator ==(other) {
    if (other is! _UserOrganizationsChange_wrapper) return false;
...
final class UserOrganizationsChanged implements UserOrganizationsChanged_orMutable {
  ...
  static final _serializerBuilder = _skir.internal__StructSerializerBuilder(
    ...
    defaultInstance: defaultInstance,
    newMutable: (it) => (it != null) ? it.toMutable() : mutable(),
    toFrozen: (UserOrganizationsChanged_mutable it) => it.toFrozen(),
    getUnrecognizedFields: (it) => it._u,
    setUnrecognizedFields: (it, u) => it._u = u,
  );
}
...
final class UserOrganizationsChanged_mutable implements UserOrganizationsChanged_orMutable {
  ...
  _core.List<UserOrganizationsChange> get mutableChanges {
    ...
    if (value is _skir.internal__MutableList<UserOrganizationsChange>) {
      return value;
    } else {
...
sealed class CreateOrganizationResponse_Success_orMutable {
  ...
  UserOrganizationsChanged_orMutable get event;
...
final class CreateOrganizationResponse_Success implements CreateOrganizationResponse_Success_orMutable {
  ...
  @_core.override
  final UserOrganizationsChanged event;
  _skir.internal__UnrecognizedFields? _u;

  factory CreateOrganizationResponse_Success({
    required Organization_orMutable organization,
    required UserOrganizationsChanged_orMutable event,
  ...
  static _skir.StructSerializer<CreateOrganizationResponse_Success, CreateOrganizationResponse_Success_mutable> get serializer {
    if (_serializerBuilder.mustInitialize()) {
      ...
      _serializerBuilder.addField(
        ...
        "event",
        1,
        UserOrganizationsChanged.serializer,
        "",
        (it) => it.event,
        (it, v) => it.event = v,
      );
  ...
  static final _serializerBuilder = _skir.internal__StructSerializerBuilder(
    ...
    defaultInstance: defaultInstance,
    newMutable: (it) => (it != null) ? it.toMutable() : mutable(),
    toFrozen: (CreateOrganizationResponse_Success_mutable it) => it.toFrozen(),
    getUnrecognizedFields: (it) => it._u,
    setUnrecognizedFields: (it, u) => it._u = u,
  );
}
...
final class CreateOrganizationResponse_Success_mutable implements CreateOrganizationResponse_Success_orMutable {
  ...
  Organization_mutable get mutableOrganization {
    ...
    if (value is Organization_mutable) {
      return value;
    } else {
      return this.organization = (value as Organization).toMutable();
    }
  }
  ...
  UserOrganizationsChanged_mutable get mutableEvent {
    ...
    if (value is UserOrganizationsChanged_mutable) {
      return value;
    } else {
      return this.event = (value as UserOrganizationsChanged).toMutable();
    }
  }
