...
dependencies {
    ...
    imprintExtensionApi("com.typewritermc:discovery-runtime")
    imprintExtensionApi("com.typewritermc:element-types")
    imprintExtensionApi("com.typewritermc:library-types")
    imprintExtensionApi("com.typewritermc:page-types")
    imprintExtensionApi("com.typewritermc:presentation-types")
    imprintExtensionApi("com.typewritermc:realm-capability-types")
    imprintExtensionApi("com.typewritermc:typewriter-types-core")
    ...
    testImplementation("com.typewritermc:element-types")
    testImplementation("com.typewritermc:library-types")
    testImplementation("com.typewritermc:page-types")
    testImplementation("com.typewritermc:presentation-types")
    testImplementation("com.typewritermc:realm-capability-types")
    testImplementation("com.typewritermc:typewriter-types-core")
