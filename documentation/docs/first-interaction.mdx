...
import game1Video from './assets/first-interaction/game-1.webm'
import game2Video from './assets/first-interaction/game-2.webm'
import game3Video from './assets/first-interaction/game-3.webm'
import game4Video from './assets/first-interaction/game-4.webm'
...
![add-page](./assets/first-interaction/add-page.gif)
...
![create-event](./assets/first-interaction/create-event.gif)
...
![add-speaker](./assets/first-interaction/create-speaker.gif)
...
![connect-entries](./assets/first-interaction/connect-entries.gif)
...
<ReactPlayer url={game1Video} playing loop width="100%" height="100%" />
...
select our `flower` speaker we created earlier, and finally specify a duration of `20` ticks that the
...
<ReactPlayer url={game2Video} playing loop width="100%" height="100%" />
...
:::tip
We actually don't need to set any criteria on this second dialogue entry. Typewriter picks the next
dialogue to be the dialogue with the most criteria, which all must be met. In this case
`look_at_flower_initialy` has one criterion, and `look_at_flower_second_time` has none.
...
<ReactPlayer url={game3Video} playing loop width="100%" height="100%" />
...
<ReactPlayer url={game4Video} playing loop width="100%" height="100%" />
