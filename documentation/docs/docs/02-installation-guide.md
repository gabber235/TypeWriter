...
:::caution
Typewriter's web panel does **not** support external server providers such as Minehut, Aternos, or Apex. You can still Typewriter, by following [this guide](Using-tw-on-external-providers).
:::
