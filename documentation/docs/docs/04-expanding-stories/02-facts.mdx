...
The [`Basic Adapter`](../../adapters/BasicAdapter/BasicAdapter.mdx) encompasses numerous facts available for use. However, it's important to note that [`adapters`](../../adapters/README.mdx) have the capability to further augment the array of available facts.
...
In a fact you can select a group. Their are 3 types of groups:

- **Global**: Sets a fact to all players.
...
:::tip
To see all the available facts, check out the [Adapters section](../../adapters/README.mdx).
:::
