...
<ReactPlayer url={require("./assets/first-interaction/add-page.webm").default} playing loop muted width="100%" height="100%" />
...
<ReactPlayer url={require("./assets/first-interaction/create-event.webm").default} playing loop muted width="100%" height="100%" />
...
<ReactPlayer url={require("./assets/first-interaction/create-speaker.webm").default} playing loop muted width="100%" height="100%" />
...
Now that you understand the basics of TypeWriter and have made your first interaction, it's time to spice up your interaction by adding a `cinematic`. Read the [First Interaction](First-cinematic) guide to learn more!
