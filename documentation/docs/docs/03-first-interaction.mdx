...
Now that you understand the basics of TypeWriter and have made your first interaction, it's time to spice up your interaction by adding a `cinematic`. Read the [First Cinematic](04-first-cinematic.md) guide to learn more!
