...
To properly install the typewriter plugin on your paper minecraft server follow the following steps:
...
In this guide we will create our first interaction. If you haven't installed Typewriter yet, please follow the [Installation Guide](../getting-started/installation) first.
...
:::caution
If you're getting a message along the lines of "The server is not hosting the websocket. Try enabling it in the config", please refer to [Configuring the Web Panel](../getting-started/installation#configuring-the-web-panel)
:::
...
Now that you understand the basics of TypeWriter and have made your first interaction, it's time to spice up your interaction by adding a `cinematic`. Read the [First Cinematic](/cinematics) guide to learn more!
