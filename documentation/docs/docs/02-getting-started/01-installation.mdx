...
Try creating your first interaction by following the [Interactions](../03-creating-stories/01-first-story/01-interactions.mdx) guide. If you have any questions, feel free to ask them in the [Discord](https://discord.gg/HtbKyuDDBw).
