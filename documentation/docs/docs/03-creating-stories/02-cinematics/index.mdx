...
:::info
This guide builds upon the [Interactions](../01-interactions/index.mdx) guide.
...
a command. Later in the guide we'll continue the [Interactions](../01-interactions/index.mdx) guide to trigger the cinematic
from a flower.
...
Using the [Blinding Cinematic](../../../adapters/BasicAdapter/entries/cinematic/blinding_cinematic.mdx) entry, you can make the screen
...
Let's do that by modifying the flower example from [Interactions](../01-interactions/index.mdx) so that one of the
