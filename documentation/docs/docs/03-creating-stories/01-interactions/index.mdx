...
![on-interact-with-block](../../assets/interactions/on-interact-with-block.png)

### Configuring the interaction

In the inspector, set the block to `Red Tulip` (1) and set the name to `on flower click` (2).

![on-flower-click](../../assets/interactions/on_flower_click.png)
...
4. Inside the inspector, set the DisplayName to `A beautiful flower`.
