...
export default function GraphEntryInspector({ pages }: EntryInspectorProps) {
    ...
    return <div className="sm:h-[35em] w-full sm:w-80 md:w-96 p-4 overflow-y-auto">
        ...
        {selectedNodes.length === 1 && <InspectorContext.Provider value={{ defaultExpanded: true }}><EntryInspector entry={selectedNodes[0].data.entry} pages={pages} /></InspectorContext.Provider>}
