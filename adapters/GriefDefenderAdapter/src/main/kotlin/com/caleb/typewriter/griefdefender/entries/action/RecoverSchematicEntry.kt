...
@Entry("recover_schematic", "Recover a schematic for GriefDefender Claim", Colors.RED, Icons.DROPBOX)
class RecoverSchematicEntry(
    ...
    override fun execute(player: Player) {
        ...
        val claimSchematic = claim.schematics[schematicName] ?: return

        claimSchematic.apply();
    }
}