...
final autoSaverProvider = StateNotifierProvider.autoDispose<_AutoSaverNotifier, AutoSaverState>((ref) {
...
class _AutoSaverNotifier extends StateNotifier<AutoSaverState> {
  _AutoSaverNotifier(this._ref)
      : super(AutoSaverState.saved(time: DateTime.utc(0))); // Somewhere in the past to avoid saving immediately.
