...
class WritersNotifier extends StateNotifier<List<Writer>> {
  WritersNotifier(this.ref) : super([]) {
    ref
      ...
      ..listen(selectedEntryIdProvider, (_, next) => _handleStateChange(entryId: next))
  ...
  void _handleStateChange({String? pageId, String? entryId, String? field}) {
    final localPageId = pageId ?? ref.read(currentPageIdProvider);
    final localEntryId = entryId ?? ref.read(selectedEntryIdProvider) ?? "";
